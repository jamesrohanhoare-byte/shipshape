-- ShipShape — full schema bootstrap (concatenation of all migrations, in order).
-- Regenerate after adding a migration. Paste into the Supabase SQL editor for a fresh DB.
